...
import { Search, History, X, MapPin, Loader2, ArrowRight } from 'lucide-react';
...
export default function SearchBar({ onSelectCity, isLoading }: SearchBarProps) {
  ...
  return (
    <div id="search-container" ref={containerRef} className="relative w-full max-w-xl mx-auto z-50">
      <div 
            ...
            <div>
              ...
              {isSearching ? (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-slate-500 text-xs ml-2">• {city.country}</span>
                        </div>
                      </div>
                ...
                <div className="px-4 py-4 text-sm text-slate-400 italic">
                  No matching cities found. Check your spelling or try another name.
                </div>
              )}
            </div>
          )}
                  ...
                  {recentSearches.map((city) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          <span className="font-semibold text-slate-200 group-hover/item:text-white">{city.name}</span>
                          <span className="text-slate-400 text-xs ml-2">
